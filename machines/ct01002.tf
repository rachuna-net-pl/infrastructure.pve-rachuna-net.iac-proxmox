...
resource "vault_kv_secret_v2" "ct01002_credentials" {
  mount = "kv-gitlab"
  name  = "pl.rachuna-net/infrastructure/pve-rachuna-net/iac-proxmox/machine/ct01002"

  data_json = jsonencode({
    root_password    = module.ct01002.root_password
    root_private_key = module.ct01002.root_private_key
    root_public_key  = module.ct01002.root_public_key
    container_ipv4   = module.ct01002.container_ipv4
  })
}
